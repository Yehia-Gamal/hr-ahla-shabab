...
assert(read('package.json').includes('v47-smart-entry-gateway'), 'Package version must be v47-smart-entry-gateway.');
...
assert(sw.includes('v47-smart-entry-gateway') && reg.includes('v47-smart-entry-gateway'), 'Service worker cache must use v47-smart-entry-gateway.');
